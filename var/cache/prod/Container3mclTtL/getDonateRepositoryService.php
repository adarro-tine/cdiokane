...
// Returns the private 'App\Repository\DonateRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DonateRepository.php';

return $this->privates['App\\Repository\\DonateRepository'] = new \App\Repository\DonateRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
