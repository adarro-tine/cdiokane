...
// Returns the private 'App\Repository\FormateurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FormateurRepository.php';

return $this->privates['App\\Repository\\FormateurRepository'] = new \App\Repository\FormateurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
