...
// Returns the private 'App\Repository\DonationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DonationRepository.php';

return $this->privates['App\\Repository\\DonationRepository'] = new \App\Repository\DonationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
