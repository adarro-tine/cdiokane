...
class __TwigTemplate_48347fb505c5cb9cf0dfcbc3a56748fab600feaa1f8a37d86a1d1b10bc745868 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div style=\"margin-top:172px;margin-left:250px;margin-bottom:100px;padding-left:150px;box-shadow: inset 0 0 0.25em #013552, 0 0 2em gray;width:800px;height:500px;\">
     <ul class=\"nav nav-tabs nav-stacked\" style=\"margin-left:50px;\">
         ...
         <li class=\"nav-item\">
             <a href=\"";
        // line 33
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("edit_photo", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 33), "id", [], "any", false, false, false, 33)]), "html", null, true);
