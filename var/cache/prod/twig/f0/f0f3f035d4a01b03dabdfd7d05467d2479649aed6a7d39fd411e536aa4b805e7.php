...
class __TwigTemplate_06e9e8bf8fe8ac5fb7f1151eace5c61f29bdfa1f7eccd795e8feb0970d401a93 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t<div class=\"container fill_height\" style=\"padding-top:25px;\">        
        ...
        // line 123
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["categorielibelle"] ?? null), "libelle", [], "any", false, false, false, 123), "html", null, true);
        echo "</h1>
...
\t</div>
    ...
    <div class=\"widget\" >
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["categorie"]) {
            ...
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("page_produitsByCategory", ["slug" => twig_get_attribute($this->env, $this->source, $context["categorie"], "slug", [], "any", false, false, false, 145)]), "html", null, true);
            echo "\" title=\"1500+ students enrolled\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categorie"], "libelle", [], "any", false, false, false, 145), "html", null, true);
            echo "<span>3</span></a>
        </li>
        ";
        }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["ccrs"]) {
            ...
            echo "                <div class=\"card col-lg-3 \" style=\"width:200px\">
                <a href=\"";
            // line 157
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("cour", ["slug" => twig_get_attribute($this->env, $this->source, $context["ccrs"], "slug", [], "any", false, false, false, 157)]), "html", null, true);
            echo "\" class=\"a_image\">
      <img class=\"card-img-top\" src=\"data:image/png;base64,";
            // line 158
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ccrs"], "image", [], "any", false, false, false, 158), "html", null, true);
            echo "\" alt=\"Card image\">
      </a>
    ...
    <h4 class=\"card-title\" style=\"font-size:15px;font-weight:600;\">";
            // line 162
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ccrs"], "titreCours", [], "any", false, false, false, 162), "html", null, true);
            echo "</h4>
    <div class=\"rating\">
\t<div class=\"stars\">
...
\t</div>
    ...
    <h6 class=\"card-text\" style=\"margin-top:20px;text-align:center;\">";
            // line 172
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ccrs"], "prix", [], "any", false, false, false, 172), "html", null, true);
            echo " FCFA</h6>
  </div>
</div>
\t\t\t\t
...
";
    ...
    {
        return array (  331 => 190,  327 => 189,  314 => 179,  311 => 178,  299 => 172,  286 => 162,  279 => 158,  275 => 157,  272 => 156,  268 => 155,  259 => 148,  247 => 145,  243 => 144,  233 => 136,  229 => 135,  218 => 127,  212 => 123,  100 => 13,  96 => 12,  90 => 9,  84 => 8,  78 => 7,  72 => 6,  66 => 5,  60 => 4,  54 => 3,  43 => 2,);
    }
