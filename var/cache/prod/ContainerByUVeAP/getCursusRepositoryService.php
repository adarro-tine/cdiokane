...
// Returns the private 'App\Repository\CursusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CursusRepository.php';

return $this->privates['App\\Repository\\CursusRepository'] = new \App\Repository\CursusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
