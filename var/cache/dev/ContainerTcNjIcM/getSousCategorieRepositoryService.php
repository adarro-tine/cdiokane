...
// Returns the private 'App\Repository\SousCategorieRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SousCategorieRepository.php';

return $this->privates['App\\Repository\\SousCategorieRepository'] = new \App\Repository\SousCategorieRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
