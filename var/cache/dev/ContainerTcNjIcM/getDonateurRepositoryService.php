...
// Returns the private 'App\Repository\DonateurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DonateurRepository.php';

return $this->privates['App\\Repository\\DonateurRepository'] = new \App\Repository\DonateurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
