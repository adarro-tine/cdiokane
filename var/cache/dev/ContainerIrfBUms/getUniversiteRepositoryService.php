...
// Returns the private 'App\Repository\UniversiteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UniversiteRepository.php';

return $this->privates['App\\Repository\\UniversiteRepository'] = new \App\Repository\UniversiteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
