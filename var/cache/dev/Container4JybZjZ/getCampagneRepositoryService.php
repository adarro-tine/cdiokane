...
// Returns the private 'App\Repository\CampagneRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CampagneRepository.php';

return $this->privates['App\\Repository\\CampagneRepository'] = new \App\Repository\CampagneRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
