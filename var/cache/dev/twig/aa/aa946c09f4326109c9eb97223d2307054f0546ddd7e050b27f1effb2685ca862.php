...
class __TwigTemplate_f6316231f3b4f7b90c4dad422bbbe2475b2c42db7b72558044c6281fa2c5aafc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t<h6 class=\"acceuil\"><strong >";
        // line 237
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["cour"]) || array_key_exists("cour", $context) ? $context["cour"] : (function () { throw new RuntimeError('Variable "cour" does not exist.', 237, $this->source); })()), "competence", [], "any", false, false, false, 237), "html", null, true);
        echo "</strong></h6>
\t\t<p class=\"acceuil\">";
        // line 238
