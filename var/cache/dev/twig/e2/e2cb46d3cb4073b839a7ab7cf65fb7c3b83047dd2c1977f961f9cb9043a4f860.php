...
class __TwigTemplate_cb73094a8d604c00c94fcd1e9384de876e2b24d12cb84c95d94cae0ac5572412 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t<h6 class=\"acceuil\"><strong >";
        // line 229
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["cour"]) || array_key_exists("cour", $context) ? $context["cour"] : (function () { throw new RuntimeError('Variable "cour" does not exist.', 229, $this->source); })()), "competence", [], "any", false, false, false, 229), "html", null, true);
        echo "</strong></h6>
\t\t<p class=\"acceuil\">";
        // line 230
