...
class __TwigTemplate_f141f125e7be222bdeb9a6b210d21fc4f47376d214fd1ef7ea1edc3231e6956c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t</div>
    ...
    <div class=\"widget\" style=\"border:1px solid gainsboro;width:267px;\">
       ...
       <p style=\"text-align:center;color:white;padding-top:15px;\"> La liste des catégories</p>
        ...
        // line 160
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 160, $this->source); })()));
...
\t\t\t\t
    ...
    ";
        // line 184
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 184, $this->source); })()));
        echo "
</div>
                </div>
                </div>
...
";
    ...
    {
        return array (  450 => 195,  446 => 194,  433 => 184,  430 => 183,  418 => 177,  405 => 167,  398 => 163,  394 => 162,  391 => 161,  387 => 160,  378 => 153,  365 => 149,  361 => 148,  348 => 137,  338 => 136,  321 => 128,  315 => 124,  202 => 13,  192 => 12,  174 => 9,  156 => 8,  138 => 7,  120 => 6,  102 => 5,  84 => 4,  66 => 3,  43 => 2,);
    }
...
\t</div>
    ...
    <div class=\"widget\" style=\"border:1px solid gainsboro;width:267px;\">
       ...
       <p style=\"text-align:center;color:white;padding-top:15px;\"> La liste des catégories</p>
        ...
        \t<li class=\"cat-item cat-item-34\" data-slug=\"technology\"><a href=\"{{ path('page_produitsByCategory',{'slug':categorie.slug})}}\" title=\"1500+ students enrolled\" style=\"color:#053651;\">{{categorie.libelle}}<span>
</span></a>
        </li>
        {% endfor %}
        </ul>
