...
// Returns the private 'App\Repository\AddCoursRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AddCoursRepository.php';

return $this->privates['App\\Repository\\AddCoursRepository'] = new \App\Repository\AddCoursRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
